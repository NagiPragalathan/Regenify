    ...
    if request.method == 'POST':
        ...
        try:
            ...
            try:
                ...
                return render(request, "OCR_Ai/bot_temp.html",{"ai_response":zip(docs, docs_id, document_short_details, summary_of_doc, updated_time_of_doc), "response_of_question":python_dict[0].get('response_of_question')})
            except Exception as e:
                print("error : ", e)
                return render(request, "OCR_Ai/bot_temp.html",{'response_of_question': ai_response})
        
        except FileNotFoundError:
            return HttpResponse("Details not exists.")
    else:
        return render(request, "OCR_Ai/bot_temp.html")
